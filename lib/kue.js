...
Queue.prototype.types = function( fn ) {
  ...
  if (this.client && this.client.connected && !this.client.closing) {
    self.client.smembers(self.client.getKey('job:types'), fn);
  }
  return this;
};
...
Queue.prototype.workTime = function( fn ) {
  var self = this;
  if (this.client && this.client.connected && !this.client.closing) {
    self.client.get(self.client.getKey('stats:work-time'), function( err, n ) {
...
Queue.prototype.cardByType = function( type, state, fn ) {
  ...
  var self = this;
  if (this.client && this.client.connected && !this.client.closing) {
    self.client.zcard(self.client.getKey('jobs:' + type + ':' + state), fn);
  }
  return this;
};
...
Queue.prototype.card = function( state, fn ) {
  ...
  var self = this;
  if (this.client && this.client.connected && !this.client.closing) {
    self.client.zcard(self.client.getKey('jobs:' + state), fn);
  }
  return this;
};
